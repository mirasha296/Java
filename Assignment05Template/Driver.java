import java.util.*;
/** 
A driver that demonstrates the class ArraySortedList.
...
public class Driver 
{
    public static void main(String[] args) 
    {
        ...
        SortedListInterface<String> myList = new BSTSortedList<>();
        ...
        System.out.println("99 s/b at position " + myList.getPosition("99") + " (should be -10)");
        ...
        // Remove interior
        System.out.println("\nRemoving interior item (4th position, 55): " + myList.remove(4));
        System.out.println("\nAfter removing 55:");
        displayList(myList);

        // Remove last
        System.out.println("\nRemoving last item (7th position, 95): " + myList.remove(7));
        System.out.println("\nAfter removing 95:");
        displayList(myList);

        // Remove non-existant entries
        System.out.println("\nTrying to remove an entry (15) that does not exist: " + myList.remove("15"));
        System.out.println("\nTrying to remove an entry (55) that does not exist: " + myList.remove("55"));
    ...
    public static void displayList(SortedListInterface<String> aList)
    {
        int numberOfEntries = aList.getLength();
        System.out.print("The sorted list contains " + numberOfEntries +
            " entries, as follows: ");
...
/*
Create a new sorted list that is empty:
Test isEmpty with an empty list:
isEmpty finds the list empty - OK

Test add, getLength, and getEntry 
The sorted list should contain 9 entries, as follows: 15 25 35 45 55 65 75 85 95

The sorted list contains 9 entries, as follows: 15 25 35 45 55 65 75 85 95 

Test getPosition:
15 is at position 1 (should be 1)
55 is at position 5 (should be 5)
95 is at position 9 (should be 9)
0 s/b at position -1 (should be -1)
50 s/b at position -5 (should be -5)
90 s/b at position -9 (should be -9)
99 s/b at position -10 (should be -10)
...
After removing 15:
The sorted list contains 8 entries, as follows: 25 35 45 55 65 75 85 95 

Removing interior item (4th position, 55): 55
After removing 55:
The sorted list contains 7 entries, as follows: 25 35 45 65 75 85 95 

Removing last item (7th position, 95): 95
After removing 95:
The sorted list contains 6 entries, as follows: 25 35 45 65 75 85 

Trying to remove an entry (15) that does not exist: false
Trying to remove an entry (55) that does not exist: false
